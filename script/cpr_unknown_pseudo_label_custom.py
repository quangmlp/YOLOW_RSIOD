...
classes = [
    "cherry", "soap", "toothbrush", "hair dryer", "keyboard", "strawberry", "pumpkin", "mop", "trash bin", "sushi", "shrimp", "remote", "pencil case", "skateboard", "belt", "flowers", "cat", "ruler", "pizza", "tricycle", "gun", "sheep", "shovel", "chainsaw", "donut", "truck", "animal", "desk", "violin", "dolphin", "flower", "sailboat", "golf ball", "spoon", "dessert", "candy", "ambulance", "Electronics", "marker", "bow tie", "tv", "lobster", "equipment", "kettle", "tennis", "apple", "helicopter", "wild animal", "train", "storage box", "air conditioner", "radish", "refrigerator", "barbell", "lighter", "lantern", "mango", "electric drill", "trolley", "lion", "swan", "toilet", "boat", "towel", "parrot", "balloon", "tennis racket", "butterfly", "paddle", "skis", "bathtub", "handbag", "mouse", "vegetables", "pen", "asparagus", "picture", "bicycle", "Vehicles", "camel", "noddles", "street lights", "teddy bear", "lamp", "helmet", "traffic light", "fire hydrant", "stool", "egg", "vase", "toiletry", "bowl", "Trees", "broom", "Plants", "hot-air balloon", "broccoli", "telephone", "pineapple", "stick", "surfboard", "baseball glove", "pear", "earphone", "bracelet", "carrot", "hamburger", "drum", "hammer", "baseball bat", "sports ball", "couch", "garlic", "van", "Appliances", "oven", "sandwich", "bread", "nightstand", "suitcase", "coconut", "soccer", "yak", "luggage", "egg tart", "brush", "candle", "parking meter", "cell phone", "basketball", "cup", "clock", "guitar", "steak", "giraffe", "tea pot", "mask", "person", "eggplant", "chicken", "durian", "motorcycle", "deer", "tomato", "bird", "eraser", "fire extinguisher", "Furniture", "bear", "mushroom", "skiboard", "onion", "pie", "table tennis", "mirror", "ice cream", "horse", "wine glass", "fork", "bed", "orange", "cake", "jellyfish", "corn", "comb", "volleyball", "microphone", "traffic sign", "crab", "stroller", "key", "table tennis paddle", "elephant", "sausage", "vegetable", "scissors", "scooter", "speaker", "flag", "car", "potted plant", "cd", "wallet", "cabbage", "stop sign", "umbrella", "kite", "tablet", "backpack", "potato", "tape", "domestic animal", "pot", "basket", "binoculars", "donkey", "dog", "book", "Food", "fire truck", "penguin", "dumpling", "Clothing", "airplane", "chopsticks", "pig", "carpet", "tent", "piano", "ship", "jug", "printer", "treadmill", "laptop", "baseball", "goose", "rabbit", "ring", "ladder", "rice", "peach", "chair", "knife", "vehicle", "necklace", "Sports", "washing machine", "cheese", "cow", "cucumber", "banana", "Stationery", "fruit", "fish", "scallop", "camera", "lipstick", "frisbee", "bench", "cookies", "fan", "monkey", "lemon", "wheelchair", "toaster", "pet", "bucket", "pillow", "chips", "dumbbell", "radiator", "pliers", "bottle", "Drinks", "grape", "zebra", "lettuce", "bus", "sink", "building", "tie", "watermelon", "hair drier", "faucet", "microwave", "duck", "snowboard", "hot dog", "dining table", "pomegranate"
]
...
def pseudo_unknown_label(ann_file, ann_save_file, img_path, skip_scores):
    ...
    model = MmdetModel(mmdet_cfg, mmdet_pt, skip_scores=skip_scores, class_json='/content/data/texts/unknown_class_texts.json')
    coco = COCO(ann_file)
...
if __name__ == '__main__':
    ...
    if args.dataset == 'DIOR':
        ann_file = f'/content/data/DIOR/annotation/annotation/train_task_{args.stage + 1}.json'
        img_path = f'/content/data/DIOR/images/'  # Need to ensure this path is correct
    elif args.dataset == 'DOTA':
        ann_file = f'/content/data/DOTA/ann/train_task_{args.stage + 1}.json'
