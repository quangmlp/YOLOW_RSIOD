...
dior_train_dataset = dict(
    ...
    dataset=dict(
        ...
        ann_file='annotation/annotation/train_task_2.json',
        data_prefix=dict(img='images/'),
        filter_cfg=dict(filter_empty_gt=False, min_size=32)),
    class_text_path='data/DIOR/annotation/annotation/dior_class_texts_stage1_only.json',
...
dior_val_dataset = dict(
    ...
    dataset=dict(
        type='YOLOv5CocoDataset',
        data_root='data/DIOR/',
        ann_file='annotation/annotation/test_task_2.json',
        data_prefix=dict(img='images/'),
        metainfo=dict(classes=classes),
...
train_cfg = dict(
    ...
    gps_ratio=0.8,
    up_ratio=0.8,
    importance_save_path='data/DIOR/annotation/annotation/t1_importance_iks.pt',
    max_epochs=max_epochs,
    val_interval=10,
...
val_evaluator = dict(
    ...
    ann_file='data/DIOR/annotation/annotation/test_task_2.json',
    metric='bbox')
