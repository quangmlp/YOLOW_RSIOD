...
classes = [
    "airplane", "airport", "bridge", "Expressway-Service-area", "Expressway-toll-station", "baseballfield", "basketballcourt", "chimney", "dam", "golffield", "unknown_0", "unknown_1", "unknown_2", "unknown_3", "unknown_4", "unknown_5", "unknown_6", "unknown_7", "unknown_8", "unknown_9"
]
...
model = dict(
    ...
    ori_setting=dict(
        config='configs/dior_5_5_5_5/yolo_iod_dior_5_5_5_5_task0.py',
        ckpt='work_dirs/yolo_iod_dior_5_5_5_5_task0/epoch_20.pth',
    ),
    cur_setting=dict(
