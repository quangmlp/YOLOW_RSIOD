...
classes = [
    "airplane", "airport", "bridge", "Expressway-Service-area", "Expressway-toll-station", "baseballfield", "basketballcourt", "chimney", "dam", "golffield", "groundtrackfield", "stadium", "storagetank", "tenniscourt", "windmill", "harbor", "overpass", "ship", "trainstation", "vehicle"
]
...
model = dict(
    ...
    ori_setting=dict(
        config='configs/dior_5_5_5_5/yolo_iod_dior_5_5_5_5_task2.py',
        ckpt='work_dirs/yolo_iod_dior_5_5_5_5_task2/epoch_20.pth',
    ),
    cur_setting=dict(
