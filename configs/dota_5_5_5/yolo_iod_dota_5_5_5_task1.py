...
load_from = './weights/dota_5_5_5_t1.pth'
...
model = dict(
    ...
    ori_setting=dict(
        config='configs/dota_5_5_5/yolo_iod_dota_5_5_5_task0.py',
        ckpt='work_dirs/yolo_iod_dota_5_5_5_task0/epoch_20.pth',
    ),
    cur_setting=dict(
        config='configs/dota_5_5_5/yolo_iod_dota_5_5_5_stage1.py',
        ckpt='work_dirs/yolo_iod_dota_5_5_5_stage1/epoch_20.pth',
    ),
    kd_cfg=dict(
...
dota_train_dataset = dict(
    ...
    dataset=dict(
        ...
        ann_file='ann/train_task_2_ps.json',
        data_prefix=dict(img='train/images/train/'),
        filter_cfg=dict(filter_empty_gt=False, min_size=32)),
    class_text_path='/content/data/DOTA/ann/dota_class_texts_stage1.json',
...
dota_val_dataset = dict(
    ...
    dataset=dict(
        ...
        data_root='/content/data/DOTA/',
        ann_file='ann/test_task_12.json',
...
train_cfg = dict(
    ...
    gps_ratio=0.8,
    up_ratio=0.8,
    importance_save_path='/content/data/DOTA/ann/t1_importance_iod.pt',
    max_epochs=max_epochs,
    val_interval=1,
...
val_evaluator = dict(
    ...
    ann_file='/content/data/DOTA/ann/test_task_12.json',
    metric='bbox')
