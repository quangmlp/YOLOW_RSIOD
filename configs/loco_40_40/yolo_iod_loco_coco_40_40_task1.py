...
load_from = './weights/loco_40_40_t1.pth'
...
classes = ("person", "bicycle", "car", "motorcycle", "airplane", "bus", "train", "truck", "boat", "traffic light",
           ...
           "tennis racket", "hair drier", "toothbrush", "cat", "bottle", "wine glass", "cup", "fork", "knife", "spoon",
...
coco_train_dataset = dict(
    ...
    class_text_path='data/coco/loco_annotations/40+40(order)/loco_class_texts_stage1.json',
...
train_cfg = dict(
    ...
    gps_ratio=0.8,
    up_ratio=0.8,
    importance_save_path='data/coco/loco_annotations/40+40(order)/t1_importance_iod.pt',
    max_epochs=max_epochs,
    val_interval=1,
